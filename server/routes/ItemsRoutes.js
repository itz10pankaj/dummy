...
import { addItem, getItems,bulkUploadItems,bulkUploadItemsUsingWorker,UploadText} from "../controllers/getItemsController.js"
...
router.post("/bulk-upload",upload.single("file"),UploadText)
